...
<html>
  <head>
    <title>新建销售机会</title>
    <script type="text/javascript" src="${ctp }/static/jquery/jquery.js"></script>
    <script type="text/javascript" src="${ctp }/static/jquery/jquery.validate.js"></script>
   	<script type="text/javascript" src="${ctp }/static/jquery/messages_cn.js"></script>
	...
	<form:form id="chanceForm" action="${ctp }/chance/${chance.id }" method="POST" modelAttribute="chance">
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
			<tr>
				...
				<th>机会来源</th>
				<td><form:input path="source" cssClass="required" /></td>
			</tr>
			<tr>
				<th>客户名称</th>
