...
<body class="main">
	...
	<div class="button_bar">
		<button class="common_button" onclick="window.location.href='${ctp}/contact/list/${customer.id }'">
			联系人
		</button>
		<button class="common_button" onclick="window.location.href='${ctp}/activity/list/${customer.id }'">
			交往记录
		</button>
		<button class="common_button" onclick="window.location.href='${ctp}/order/list/${customer.id }'">
			历史订单
		</button>
	...
	<form:form action="${ctp}/customer/${customer.id}" method="post" modelAttribute="customer">
		<%-- <form:hidden path="id"/> --%>
